...
# Script to download zeta zeros using wget and run analysis

echo "=== Zeta Zeros Download and Analysis Script ==="
echo "This script will download zeta zeros files using wget and run the analysis"
...
echo "=== Step 1: Downloading zeta zeros files ==="

# Download files to reach approximately 1 million zeros
echo "Downloading zeros_100000.dat..."
wget -O data/zeros_100000.dat https://beta.lmfdb.org/riemann-zeta-zeros/data/zeros_100000.dat

echo "Downloading zeros_236000.dat..."
wget -O data/zeros_236000.dat https://beta.lmfdb.org/riemann-zeta-zeros/data/zeros_236000.dat

echo "Downloading zeros_446000.dat..."
wget -O data/zeros_446000.dat https://beta.lmfdb.org/riemann-zeta-zeros/data/zeros_446000.dat

echo "Downloading zeros_674000.dat..."
wget -O data/zeros_674000.dat https://beta.lmfdb.org/riemann-zeta-zeros/data/zeros_674000.dat

echo "=== Step 2: Combining files ==="

# Combine files to create a single file with 1 million zeros
cat data/zeros_100000.dat data/zeros_236000.dat data/zeros_446000.dat data/zeros_674000.dat > data/combined_zeros.dat

# Count lines to verify
TOTAL_LINES=$(wc -l < data/combined_zeros.dat)
echo "Combined file contains $TOTAL_LINES zeros"

# Limit to 1 million if more
if [ $TOTAL_LINES -gt 1000000 ]; then
    echo "Limiting to 1 million zeros..."
    head -n 1000000 data/combined_zeros.dat > data/zeta_zeros_1m.dat
    TOTAL_LINES=1000000
else
    cp data/combined_zeros.dat data/zeta_zeros_1m.dat
fi

echo "Final dataset contains $TOTAL_LINES zeros"

echo "=== Step 3: Creating Python analysis script ==="

cat > zeta_analysis_wget.py << 'EOF'
import numpy as np
...
# Configuration
INPUT_FILE = "data/zeta_zeros_1m.dat"
OUTPUT_DIR = "output"
FIGURES_DIR = "figures"
